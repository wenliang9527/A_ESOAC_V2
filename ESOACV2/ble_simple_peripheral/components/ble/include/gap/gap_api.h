...
typedef enum
{
    ...
    GAP_EVT_ADV_START,              //!< Advertising started
    ...
    GAP_SEC_EVT_ENCRYPT_REQ,        //!< Link encrypt request
...
typedef struct
{
    ...
    uint8_t status;          //!< Adv start status
} adv_start_t;
// Adv end event
typedef struct
{
...
typedef struct
{
    ...
    union
    {
        ...
        gap_encrypt_req_t               encrypt_req;             //!<encrypt request,when device is bonded
