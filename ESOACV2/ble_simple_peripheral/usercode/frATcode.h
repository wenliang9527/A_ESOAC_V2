...
/* ע�⣺���¾ɵ�URC��ض����ѱ�urc_parser.hȡ�����������ڼ�����
 * - ml307a_urc_type_t  -> ʹ�� urc_type_t
 * - mqtt_recv_state_t  -> ���Ƴ���ʹ��urc_queue_t
 * - mqtt_recv_ctx_t    -> ���Ƴ���ʹ��urc_queue_t
 */

// �����ɵ�mqtt_recv_ctx_t�������ڼ����ԣ���ѡ����������Ƴ���
// �´���Ӧֱ��ʹ��urc_parser.h�е�urc_queue_t
...
typedef struct {
    ...
    // ʹ���µ�URC��������ɵ�mqtt_recv_ctx_t
    urc_queue_t     urc_queue;      // URC���ζ���
    os_timer_t      urc_timer;      // URC������ʱ��
    bool            urc_timer_inited; // ��ʱ����ʼ����־
} at_command_t;
