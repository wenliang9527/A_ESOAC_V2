# Embedded generator (extract with tools/extract_docx_generator.py or manual copy)

The following block is the full `tools/generate_esoac_protocol_docx.py` source.
